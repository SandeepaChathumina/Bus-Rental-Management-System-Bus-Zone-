...
const NotificationBell = () => {
  ...
  const getNotificationIconColor = (type) => {
    switch (type) {
      ...
      case 'seasonal_offer': return 'text-amber-400';
      case 'booking_confirmation': return 'text-indigo-400';
      case 'reminder': return 'text-yellow-400';
      case 'package': return 'text-blue-400';
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center mb-2">
                          <div className={`w-2 h-2 rounded-full mr-3 flex-shrink-0 ${
                            !isRead ? 'bg-amber-400 animate-pulse' : 'bg-transparent'
                          }`}></div>
