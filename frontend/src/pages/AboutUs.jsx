...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50 text-slate-800">
      {/* Navigation */}
      <nav className="bg-white/95 backdrop-blur-xl border-b border-blue-200/50 py-4 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button 
              onClick={() => navigate('/')}
              className="flex items-center space-x-2 text-blue-600 hover:text-cyan-600 transition-colors px-4 py-2 rounded-lg hover:bg-blue-50"
            >
      ...
      <div className="relative py-0 overflow-hidden">
        <div className="relative h-96 lg:h-screen max-h-[700px] w-full">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
            <div className="mb-4">
              <span className="text-sm font-medium text-cyan-600 tracking-wider">PREMIUM TRANSPORTATION SERVICES</span>
            </div>
      ...
      {/* Content Section */}
      <div className="relative py-16 lg:py-24 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            {/* Content Section */}
            <div className="w-full lg:w-1/2">
              <div className="mb-4">
                <span className="text-sm font-medium text-cyan-600">WHO WE ARE</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-800">Excellence in Transportation</h2>
            ...
            <div className="w-full lg:w-1/2">
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div key={index} className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-blue-200/50 shadow-lg text-center transition-all duration-300 hover:border-blue-400/50 hover:shadow-xl">
      ...
      {/* Values Section */}
      <div className="py-16 lg:py-20 bg-gradient-to-r from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center mb-4">
              <div className="w-12 h-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 mr-3"></div>
              <span className="text-sm font-medium text-cyan-600">OUR PRINCIPLES</span>
              <div className="w-12 h-0.5 bg-gradient-to-r from-cyan-600 to-blue-600 ml-3"></div>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-5 text-slate-800">Our Core Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => {
              ...
              return (
                <div key={index} className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-blue-200/50 hover:border-blue-400/50 transition-all duration-300 group shadow-lg hover:shadow-xl">
                  <div className="bg-gradient-to-r from-blue-600 to-cyan-600 p-3 rounded-xl w-fit mb-5 group-hover:scale-105 transition-transform duration-300 shadow-lg">
                    <Icon className="h-7 w-7 text-white" />
                  </div>
                  <h3 className="text-xl font-semibold mb-3 group-hover:text-blue-600 transition-colors duration-300 text-slate-800">{value.title}</h3>
      ...
      {/* History Section */}
      <div className="py-16 lg:py-20 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2">
              <div className="mb-4">
                <span className="text-sm font-medium text-cyan-600">OUR JOURNEY</span>
              </div>
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-600 to-cyan-600 p-6 rounded-xl text-center shadow-lg transform transition-transform duration-300 hover:-translate-y-1">
                <Users className="h-10 w-10 text-white mx-auto mb-4" />
                <div className="text-2xl font-bold mb-1 text-white">150+</div>
                <div className="text-blue-100 text-sm">Professional Staff</div>
              </div>
              
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl text-center border border-blue-200/50 shadow-lg transform transition-transform duration-300 hover:-translate-y-1">
                <MapPin className="h-10 w-10 text-blue-600 mx-auto mb-4" />
                <div className="text-2xl font-bold mb-1 text-slate-800">25+</div>
                <div className="text-slate-600 text-sm">Destinations Served</div>
              </div>
              
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl text-center border border-blue-200/50 shadow-lg transform transition-transform duration-300 hover:-translate-y-1">
                <Award className="h-10 w-10 text-blue-600 mx-auto mb-4" />
                <div className="text-2xl font-bold mb-1 text-slate-800">12</div>
                <div className="text-slate-600 text-sm">Industry Awards</div>
              </div>
