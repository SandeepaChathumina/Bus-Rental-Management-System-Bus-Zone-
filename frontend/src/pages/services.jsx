  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Executive Luxury */}
            <div className="bg-slate-800/30 p-6 rounded-3xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300">
              <div className="mb-6">
                <img 
                  src={buspic4} 
              ...
              <h3 className="text-2xl font-bold mb-4">Executive Luxury</h3>
            ...
            <div className="bg-slate-800/30 p-6 rounded-3xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-4">Premium Coach</h3>
              <ul className="space-y-3 text-slate-300 mb-6">
                <li className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Users className="h-4 w-4 text-blue-400" />
            ...
            <div className="bg-slate-800/30 p-6 rounded-3xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-4">Mini Party Bus</h3>
              <ul className="space-y-3 text-slate-300 mb-6">
                <li className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Users className="h-4 w-4 text-blue-400" />
      ...
      <div className="py-16 bg-gradient-to-r from-slate-900 to-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Our Additional Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-800/30 p-8 rounded-3xl border border-slate-700/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">Luggage Service</h3>
              </div>
            ...
            <div className="bg-slate-800/30 p-8 rounded-3xl border border-slate-700/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">Online Booking</h3>
              </div>
              <p className="text-slate-300">
            ...
            <div className="bg-slate-800/30 p-8 rounded-3xl border border-slate-700/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">Public Transport</h3>
              </div>
              <p className="text-slate-300">
            ...
            {/* Special Hires */}
            <div className="bg-slate-800/30 p-8 rounded-3xl border border-slate-700/50 md:col-span-2">
              <div className="flex items-center mb-6">
                <div className="bg-gradient-to-r from-blue-500 to-cyan-600 p-3 rounded-xl mr-4">
                  <Bus className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-2xl font-bold">Special Hires</h3>
              </div>
              ...
              <h4 className="text-xl font-semibold mt-6 mb-4">Amenities in our luxury buses</h4>
              <p className="text-slate-300 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                <div className="flex items-center">
                  ...
                  <span className="text-slate-300">Fully Air-Conditioned</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Package className="h-4 w-4 text-blue-400" />
                  </div>
                  <span className="text-slate-300">Significant Undercarriage Storage</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Tv className="h-4 w-4 text-blue-400" />
                  </div>
                  <span className="text-slate-300">TV</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Wifi className="h-4 w-4 text-blue-400" />
                  </div>
                  <span className="text-slate-300">High Speed Internet Facility</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Coffee className="h-4 w-4 text-blue-400" />
                  </div>
                  <span className="text-slate-300">Cool Box</span>
                </div>
                <div className="flex items-center">
                  <div className="bg-blue-500/20 p-1 rounded mr-3">
                    <Zap className="h-4 w-4 text-blue-400" />
                  </div>
                  <span className="text-slate-300">Reclining, Comfortable Seats with USB Charging Point</span>
                </div>
              </div>
